...
Control Arduino With Your Own Voice is a hands-on course focused on practical Arduino
...
- Understand the core goals of the **Control Arduino With Your Own Voice** lessons.
...
sensors/actuators described in the Control Arduino With Your Own Voice videos, jumper
...
# Or upload via Arduino IDE to replicate the Control Arduino With Your Own Voice lab
```
